...
BaseDefaults --> PluginDefaults["应用插件特定默认值"]
...
**章节来源**
- [packages/core/src/plugins/injectIco/index.ts](file://packages/core/src/plugins/injectIco/index.ts#L14-L171)
