...
## 更新摘要
**所做更改**
- 更新版本信息：项目从0.0.2版本升级到0.0.3版本
- 更新版本号显示：所有相关文件中的版本号已更新为0.0.3
- 保持核心功能描述不变：版本更新不影响项目的核心架构和功能特性
...
**更新** 项目已从0.0.2版本升级到0.0.3版本，继续提供稳定可靠的插件开发体验。
...
**更新** 项目已升级到0.0.3版本，继续提供稳定的版本兼容性保证。
...
**更新** 项目已升级到0.0.3版本，继续提供稳定可靠的功能特性和持续的改进支持。
