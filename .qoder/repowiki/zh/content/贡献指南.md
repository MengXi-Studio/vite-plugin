...
- [ESLint 扁平配置](file://eslint.config.js)
- [Prettier 配置](file://.prettierrc)
- [Git 忽略配置](file://.gitignore)
...
## 更新摘要
**所做更改**
- 更新了 ESLint 配置部分，反映从传统 .eslintrc.js 和 .eslintignore 配置迁移到现代 eslint.config.js 扁平配置格式
- 新增了关于 ESLint 扁平配置格式的详细说明和最佳实践
- 更新了代码规范与风格章节中的 ESLint 配置相关信息
- 修正了相关章节的文件引用和配置说明
...
**图表来源**
- [根 package.json](file://package.json#L8-L10)
- [pnpm 工作区配置](file://pnpm-workspace.yaml#L1-L2)
- [核心包 package.json](file://packages/core/package.json#L1-L73)
...
**章节来源**
- [根 package.json](file://package.json#L1-L49)
- [pnpm 工作区配置](file://pnpm-workspace.yaml#L1-L2)
...
**章节来源**
- [根 package.json](file://package.json#L7-L24)
- [pnpm 工作区配置](file://pnpm-workspace.yaml#L1-L2)
- [核心包 package.json](file://packages/core/package.json#L49-L52)
...
**更新** 反映了 ESLint 配置从传统格式迁移到现代扁平配置格式的重要变更

- ESLint 配置要点（扁平配置格式）
  - 配置文件：eslint.config.js（现代扁平配置格式）
  - 解析器：TypeScript ESLint 解析器
  - 环境：Node、浏览器、ES2022
  - 扩展：ESLint 推荐规则 + TypeScript 推荐规则 + Prettier 推荐规则
  - 全局忽略：通过 ignores 数组配置，包含 node_modules、dist、.git、锁文件、编辑器配置、环境变量、日志文件、OS 生成文件等
  - 关键规则：
...
- 代码格式化流程
  ...
  - ESLint 扁平配置支持更灵活的规则组合和条件配置

**章节来源**
- [eslint.config.js](file://eslint.config.js#L1-L77)
- [.prettierrc](file://.prettierrc#L1-L17)
- [根 package.json](file://package.json#L21-L23)
...
**图表来源**
- [根 package.json](file://package.json#L18-L20)
...
**章节来源**
- [根 package.json](file://package.json#L20-L23)
...
**章节来源**
- [根 package.json](file://package.json#L37-L47)
