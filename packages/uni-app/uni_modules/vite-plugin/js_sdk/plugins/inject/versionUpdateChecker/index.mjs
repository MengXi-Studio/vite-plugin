import{createPluginFactory as d,BasePlugin as p}from"../../../factory/index.mjs";import{makeCallback as i}from"../../../common/script/index.mjs";import{parseTemplateWithDelimiter as v}from"../../../common/format/index.mjs";import{validateNoScriptInTemplate as f,validateGlobalName as m,validateCallbackFields as b}from"../../../common/validation/index.mjs";import{injectHeadAndBody as F}from"../../../common/html/index.mjs";import"../../../logger/index.mjs";import"../../../shared/vite-plugin.DcExl6jd.mjs";import"../../../common/object/index.mjs";import"../../../shared/vite-plugin.CuXEJAWX.mjs";function h(e,n){const u=".__vuc-overlay__{position:fixed;top:0;left:0;right:0;bottom:0;z-index:99999;pointer-events:none;}";let t="";switch(e){case"modal":t=`.__vuc-modal__{position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);background:#fff;border-radius:12px;box-shadow:0 8px 32px rgba(0,0,0,0.15);padding:32px;max-width:420px;width:90%;z-index:100000;pointer-events:auto;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;text-align:center;}
...
<button class="__vuc-btn__ __vuc-btn-dismiss__" onclick="window.__VUC_DISMISS__()">${r}</button>
<button class="__vuc-btn__ __vuc-btn-refresh__" onclick="window.__VUC_REFRESH__()">${t}</button>
</div></div></div>`}}function x(e){const n=e.versionSource||"auto",u=e.defineName||"__APP_VERSION__",t=e.checkUrl||"/version.json",r=e.checkInterval||3e5,o=e.checkOnVisibilityChange!==!1,_=e.enableInDev||!1,a=i(e.onUpdateAvailable,"versionUpdateChecker","currentVersion, newVersion"),c=i(e.onRefresh,"versionUpdateChecker","currentVersion, newVersion"),l=i(e.onDismiss,"versionUpdateChecker","currentVersion, newVersion");let s="";return(n==="define"||n==="auto")&&(s=`
    // \u4F18\u5148\u4ECE define \u5168\u5C40\u53D8\u91CF\u8BFB\u53D6
  ...
  if (_isDev && !${JSON.stringify(_)}) return;
...
})();`}function g(e){const n=e.versionSource||"auto";return n!=="file"&&n!=="auto"?"":`<meta name="app-version" content="${e.defineName||"__APP_VERSION__"}">`}function E(e){const n=h(e.promptStyle||"modal",e.customStyle),u=C(e),t=x(e);return`${n}
<div id="__vuc-root__" style="display:none">${u}</div>
<script>${t}<\/script>`}function y(e){b(e,["onUpdateAvailable","onRefresh","onDismiss"],"callbacks")}function B(e){f(e.customPromptTemplate,"customPromptTemplate"),y(e),m(e.defineName,"defineName")}class w extends p{getDefaultOptions(){return{versionSource:"auto",defineName:"__APP_VERSION__",checkUrl:"/version.json",checkInterval:3e5,checkOnVisibilityChange:!0,enableInDev:!1,promptStyle:"modal",promptMessage:"\u53D1\u73B0\u65B0\u7248\u672C\uFF0C\u662F\u5426\u7ACB\u5373\u5237\u65B0\u83B7\u53D6\u6700\u65B0\u5185\u5BB9\uFF1F",refreshButtonText:"\u7ACB\u5373\u5237\u65B0",dismissButtonText:"\u7A0D\u540E\u518D\u8BF4"}}validateOptions(){this.validator.field("versionSource").enum(["define","file","auto"]).field("promptStyle").enum(["modal","banner","toast"]).field("checkInterval").number().minValue(5e3).validate(),B(this.options)}getPluginName(){return"version-update-checker"}addPluginHooks(n){const u=E(this.options),t=g(this.options);this.registerTransformIndexHtml(n,r=>{const o=F(r,t,u);return o.usedFallback&&this.logger.warn("\u672A\u627E\u5230 </body> \u6216 </html> \u6807\u7B7E\uFF0C\u7248\u672C\u66F4\u65B0\u68C0\u67E5\u4EE3\u7801\u8FFD\u52A0\u5230\u6587\u4EF6\u672B\u5C3E"),o.bodyInjected&&this.logger.success("\u6210\u529F\u6CE8\u5165\u7248\u672C\u66F4\u65B0\u68C0\u67E5\u4EE3\u7801\u5230 HTML \u6587\u4EF6"),o.html},"\u6CE8\u5165\u7248\u672C\u66F4\u65B0\u68C0\u67E5\u4EE3\u7801")}}const S=d(w);export{S as versionUpdateChecker};
