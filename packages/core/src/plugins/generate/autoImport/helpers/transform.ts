 ...
 */
export function detectVueDirectiveImports(
	code: string,
	nameLookup: Map<string, ImportInline>,
	ignore: Set<string>,
	config?: boolean | VueDirectivesConfig
): ImportInline[] {
	if (!config) return []
	...
	for (const [name, imp] of nameLookup) {
		...
		const isDirectiveImport = imp.meta?.vueDirective === true
			|| (isDirective && isDirective(imp.from, imp))
...
const HTML_TAGS = new Set([
	...
	'aside', 'script', 'style', 'link', 'meta', 'title', 'head', 'body', 'html', 'br', 'hr',
	'pre', 'code', 'em', 'strong', 'b', 'i', 'u', 'sub', 'sup', 'small', 'mark', 'del',
	'ins', 'blockquote', 'q', 'cite', 'abbr', 'dfn', 'kbd', 'samp', 'var', 'time', 'figure',
	'figcaption', 'details', 'summary', 'dialog', 'menu', 'template', 'slot', 'component',
	'transition', 'transition-group', 'keep-alive', 'teleport', 'suspense', 'video', 'audio',
	'source', 'canvas', 'svg', 'path', 'circle', 'rect', 'line', 'polygon', 'iframe',
	'embed', 'object', 'picture', 'area', 'map', 'base', 'col', 'colgroup', 'datalist',
	'fieldset', 'legend', 'meter', 'optgroup', 'output', 'progress', 'ruby', 'rt', 'rp', 'wbr',
	// uni-app 内置组件
	'view', 'text', 'image', 'scroll-view', 'swiper', 'swiper-item', 'icon', 'progress',
	'rich-text', 'navigator', 'web-view', 'picker', 'picker-view', 'checkbox', 'checkbox-group',
	'radio', 'radio-group', 'switch', 'slider', 'stepper', 'editor', 'ad', 'cover-view',
	'cover-image', 'map', 'camera', 'live-player', 'live-pusher', 'movable-view', 'movable-area',
	'uni-icons', 'uni-badge', 'uni-card', 'uni-list', 'uni-list-item', 'uni-nav-bar',
])
