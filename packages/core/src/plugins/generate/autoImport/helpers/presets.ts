...
export const BUILTIN_PRESETS: Record<string, PresetDefinition> = {
	...
	'vue-router': {
		from: 'vue-router',
		imports: ['useRouter', 'useRoute', 'onBeforeRouteLeave', 'onBeforeRouteUpdate', 'RouterLink', 'RouterView', 'createRouter', 'createWebHistory', 'createWebHashHistory', 'createMemoryHistory'],
		typeImports: [
			'RouteLocationRaw',
	...
	pinia: {
		from: 'pinia',
		imports: ['defineStore', 'storeToRefs', 'acceptHMRUpdate', 'createPinia', 'getActivePinia', 'setActivePinia', 'mapActions', 'mapGetters', 'mapState', 'mapStores', 'mapWritableState'],
		typeImports: ['Store', 'StoreDefinition', 'StoreGeneric', 'Pinia', 'PiniaPlugin', 'PiniaStorePlugin', 'StateTree', 'SubscriptionCallback']
	},
	...
	'vue-demi': {
		...
		typeImports: ['Ref', 'ComputedRef', 'WritableComputedRef', 'Component']
	},

	'vue-i18n': {
		from: 'vue-i18n',
		imports: ['useI18n', 'createI18n'],
		typeImports: ['I18n', 'I18nOptions', 'Composer', 'VueI18n']
	},
	...
	rxjs: {
		...
		typeImports: ['Observer', 'Subscribable', 'SubscribableOrPromise', 'Subscription', 'Unsubscribable', 'TeardownLogic', 'OperatorFunction', 'MonoTypeOperatorFunction']
	},
	...
	'@vueuse/core': {
		...
		typeImports: ['UseFetchOptions', 'UseFetchReturn', 'UseMouseEvent', 'UseMouseReturnType']
	}
}
